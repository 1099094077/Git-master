...
*/
?>
<!-- 版权声明：本页面内容由 幻杀博客（ihuan.me） 复制修改至本站 制作归属权为 烂番茄 （lfqie.com）  -->
    <head>
        ...
        <title>安静发现自己（frind-yourself） - <?php bloginfo('name'); ?> - 找回属于你我的心灵归属地</title>
        ...
        </style><script id="bdlike_shell"></script>
...
document.getElementById("bdlike_shell").src="http://bdimg.share.baidu.com/static/js/like_shell.js?t=" + Math.ceil(new Date()/3600000);
        ...
        <script type="text/javascript">
            ...
            $(function(){
                ...
                $("#music").html('<embed src="http://hsdate.qiniudn.com/quiet.swf" rel="external nofollow" autostart="true" loop="true" hidden="true"></embed>');
...
<div style="font-size:12px;"><p style="text-align: center;">原版制作版权为 <a href="http://lfqie.com" target="_blank">烂番茄</a> 由 <a href="http://ihuan.me" target="_blank">幻杀博客</a> 进行部分修改！</p>
<p style="text-align: center;">添加本页面 源码获取 <a href="http://ihuan.me/2077.html" target="_blank">点击这里</a></p></div>
        ...
        <p id="op_result"><div align="center"><div class="bdlikebutton"></div></div></p>
