...
body_class(); ?>>
<!-- 全屏大背景 -->  
<?php $random_image = rand(1, 5);?><div id="div1">
<style>
body{background-image:url(<?php bloginfo('stylesheet_directory');?>/images/background/<?php echo $random_image; ?>.jpg);
background-size: cover;background-attachment: fixed;background-position: center center;background-repeat: no-repeat;}
</style>
</div><div id="bg1"></div>
 <style> #div{
    opacity:0.4;
    filter:alpha(opacity=40);/* 针对 IE8 以及更早的版本 */ }</style>
<!-- end 全屏大背景-->
<?php
