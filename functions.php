...
jQuery(document).ready(function($) {
    hs.graphicsDir = "'.get_bloginfo('wpurl').'/wp-content/themes/Git-master/css/img/graphics/";
...
<script type="text/javascript" src="'.get_bloginfo('wpurl').'/wp-content/themes/Git-master/js/highslide-with-html.packed.js"></script>
<link rel="stylesheet" href="'.get_bloginfo('wpurl').'/wp-content/themes/Git-master/css/highslide.css" type="text/css" />
	');
}
